            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">New Category</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card-body p-0">
                ...
                <div class="card card">
                    <div class="card-header"  style="background-color: #008374;">
                        <h3 class="card-title" style="color:white;">Create Category</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="save_category.php" method="post">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn" style="background-color: #008374;color:white;">Submit</button>
                        </div>
                    </form>
                </div>
                <!-- /.card -->
